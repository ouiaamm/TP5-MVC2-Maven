...
<div class="container mt-4">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h2 class="text-primary">Gestion des Produits (MVC2)</h2>
    </div>
    ...
    <div class="card p-3 mb-4 shadow-sm">
        ...
        <form action="controller" method="get" class="d-flex gap-2">
            ...
            <c:forEach var="p" items="${listeProduits}">
                <tr>
                    ...
                    <td>
                        ...
                        <!-- EDIT -->
                        <a href="controller?action=edit&id=${p.idProduit}"
                           class="btn btn-sm btn-warning">
                            Modifier
                        </a>

                        <!-- DELETE -->
                        <a href="controller?action=delete&id=${p.idProduit}"
